...
public class GroupTest {
  ...
  public void testGroup() throws Throwable {
    ...
    String json = TestUtilities.serialize(groupModel);

    Group groupModelNew = TestUtilities.deserialize(json, Group.class);
    assertTrue(groupModelNew instanceof Group);
    assertEquals(groupModelNew.name(), "testString");
    assertEquals(groupModelNew.credentials().toString(), credentialVariableDataModel.toString());
  }
}
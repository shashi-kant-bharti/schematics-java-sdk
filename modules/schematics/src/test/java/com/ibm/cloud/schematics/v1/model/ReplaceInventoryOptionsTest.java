...
public class ReplaceInventoryOptionsTest {
  ...
  public void testReplaceInventoryOptions() throws Throwable {
    ...
    assertEquals(replaceInventoryOptionsModel.connectionType(), "testString");
    assertEquals(replaceInventoryOptionsModel.credentials(), java.util.Arrays.asList(credentialVariableDataModel));
    assertEquals(replaceInventoryOptionsModel.commonCredentials(), credentialVariableDataModel);
    ...
    assertEquals(replaceInventoryOptionsModel.bastion(), bastionResourceDefinitionModel);
    assertEquals(replaceInventoryOptionsModel.bastionCredential(), credentialVariableDataModel);
    assertEquals(replaceInventoryOptionsModel.inventoryView(), inventoryViewModel);
  }

...
/**
 * Unit test class for the InventoryView model.
 */
public class InventoryViewTest {
  ...
  @Test
  public void testInventoryView() throws Throwable {
    ...
    String json = TestUtilities.serialize(inventoryViewModel);

    InventoryView inventoryViewModelNew = TestUtilities.deserialize(json, InventoryView.class);
    assertTrue(inventoryViewModelNew instanceof InventoryView);
  }
}